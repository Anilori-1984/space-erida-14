ent-MaterialWatcherWing = крыло наблюдателя
    .desc = Оно прочное и при этом легко соединяется с другими, поэтому отлично подходит для создания новых инструментов.
...
ent-MaterialWatcherMagmaWing = крыло магматического наблюдателя
    .desc = Крыло, внутри которого течёт магма. Оно прочное и при этом легко сливается с другими, поэтому отлично подходит для создания новых инструментов.
...
ent-MaterialWatcherIceWing = крыло ледяного наблюдателя
    .desc = Крыло, сделанное изо льда, но почему-то отказывающееся таять. Оно прочное и при этом легко сливается с другими, что делает его отличным материалом для новых инструментов.
